...
function buildPrompt(assignmentType: AssignmentTypeValue): string {
  ...
  return `You are converting a CELTA "${assignmentType}" written assignment brief (attached, from a training centre) into the chunked "instruction on top of a response box" structure Connect uses.
