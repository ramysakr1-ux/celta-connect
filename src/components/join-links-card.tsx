  ...
  return (
    <form action={action} className="flex items-center gap-2">
      ...
      <input
        ...
        required
        className="flex-1 rounded-[6px] border border-border bg-card px-3 py-1.5 text-body text-ink outline-none focus:border-primary"
      />
      <button
        type="submit"
        disabled={pending}
        className="rounded-[6px] border border-border px-3 py-1.5 text-body text-ink hover:border-primary disabled:opacity-60"
      >
  ...
  return (
    <div className="flex flex-col gap-1.5">
      ...
      <div className="flex items-center gap-2">
        <code className="flex-1 truncate rounded-[6px] border border-border bg-card px-3 py-2 text-body text-ink">
          {link}
        </code>
        <button
          type="button"
          onClick={handleCopy}
          className="rounded-[6px] border border-border px-3 py-2 text-body text-ink hover:border-primary"
        >
          {copied ? "Copied!" : "Copy"}
        </button>
...
export function JoinLinksCard({
  ...
  return (
    <div className="card flex flex-col gap-4 p-6">
      <div>
        <h2 className="font-serif text-h3 text-ink">Or share a general link</h2>
