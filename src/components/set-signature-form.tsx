...
export function SetSignatureForm({ fullName }: { fullName: string }) {
  ...
  return (
    <form action={action} className="flex flex-col gap-2 rounded-[6px] border border-dashed border-border p-3.5">
      <p className="text-body font-medium text-ink">Set your signature</p>
      ...
      <div className="flex flex-col gap-2 sm:flex-row">
        ...
        <button
          type="submit"
          disabled={pending}
          className="shrink-0 rounded-[6px] bg-primary px-4 py-1.5 text-body font-medium text-primary-foreground disabled:opacity-60"
        >
