...
const SAMPLES: { key: string; label: string; source: string; html: string }[] = [
  ...
  {
    key: "acceptance",
    label: "Acceptance — deposit secures the place",
    source: "Course Emails.dc.html",
    html: acceptancePlaceEmailHtml({
      candidateName: "Aylin",
      courseName: "CELTA IT059",
      courseDates: "6 January to 1 February",
      centreLocation: "our Istanbul centre",
      feeAmount: "24,500 TL",
      depositAmount: "5,000 TL",
      depositBy: "Friday 12 December",
      balanceBy: "20 December",
      payUrl: null,
      officeContact: "admissions@example.com",
  ...
  {
    key: "starts_monday",
    label: "Welcome — the Friday before",
    source: "Course Emails.dc.html",
    html: startsMondayEmailHtml({
      candidateName: "Aylin",
      courseName: "CELTA IT059",
      startTime: "09:30",
      startDay: "Monday 6 January",
      room: "Room 6 on the second floor",
      groupName: "Group ABC",
      levelName: "elementary",
      tutorNames: "Nazlı Aydın and Deniz Arslan",
      activitiesUrl: "https://celtaconnect.com/activities/sample",
      directorName: "Nazlı Aydın",
      directorRole: "Course Director",
    }),
  },
  {
    key: "late_enrolment",
    label: "Welcome — late enrolment",
    source: "Course Emails.dc.html",
    html: lateEnrolmentEmailHtml({
      candidateName: "Emre",
      courseName: "CELTA IT059",
      daysNotice: "four days",
      startTime: "09:30",
      startDay: "Monday 6 January",
      room: "Room 6, second floor",
      groupName: "Group DEF",
      levelName: "elementary",
      tutorNames: "Nazlı Aydın and Deniz Arslan",
