  ...
  return (
    ...
    >
      ...
      <button
        type="submit"
        disabled={pending}
        className="rounded-[6px] border border-border bg-card px-3 py-1.5 text-xs font-medium text-ink hover:border-destructive hover:text-destructive disabled:opacity-60"
      >
