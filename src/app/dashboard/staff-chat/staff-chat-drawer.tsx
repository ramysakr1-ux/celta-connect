      ...
      <div className="pointer-events-auto flex w-full max-w-[840px] flex-col gap-2" onKeyDown={handleKeyDown}>
            ...
            {coworkers.map((c) => {
              ...
              return (
                <button
                  ...
                  disabled={startingDm}
                  onClick={() => startDm(c)}
                  className={`wash flex w-full items-center gap-2.5 rounded-[11px] px-3 py-2.5 text-left hover:bg-accent/40 disabled:opacity-60 ${
        ...
        <div className="flex min-h-14 items-center gap-1.5 rounded-[28px] border border-border bg-card pl-2 pr-2.5 shadow-lg sm:gap-3">
          ...
          <button
            ...
            className="wash hidden size-[34px] shrink-0 items-center justify-center rounded-full text-muted hover:bg-accent/40 hover:text-ink sm:flex"
          >
