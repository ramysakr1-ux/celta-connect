...
export function AddVideoForm() {
  ...
  return (
    <form action={action} className="sheet flex flex-col gap-3 p-6">
      <h2 className="font-serif text-h3 text-ink">Add a video</h2>
      ...
      <div className="flex flex-col gap-1.5">
        <label htmlFor="description" className="text-body text-muted">
      ...
      <div className="flex flex-col gap-1.5">
        <label htmlFor="video_url" className="text-body text-muted">
          Video link
        </label>
        <input
          id="video_url"
