...
function TintEmpty() {
  return (
    ...
    <div className="group-frame-inner relative rounded-[12px] bg-card px-[22px] py-4">
...
function TintPresent({
  ...
  return (
    ...
    <div className="group-frame-inner relative flex flex-col gap-4 rounded-[12px] bg-card px-[22px] py-5">
