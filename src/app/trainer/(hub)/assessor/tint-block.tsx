...
function TintEmpty() {
  return (
    ...
    <div className="group-frame-inner trainer-hover relative rounded-[12px] bg-card px-[22px] py-4" style={{ borderTop: "3px solid var(--hub-accent)" }}>
...
function TintPresent({
  ...
  return (
    ...
    <div
      className="group-frame-inner trainer-hover relative flex flex-col gap-4 rounded-[12px] bg-card px-[22px] py-5"
