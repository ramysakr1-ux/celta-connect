            ...
            {visibleAlerts.length === 0 ? (
              ...
              visibleAlerts.map((alert, i) => (
                <Link
                  key={i}
                  href={alert.href}
                  className={`-mx-2 flex flex-col gap-0.5 rounded-[6px] px-2 py-2.5 transition-colors duration-150 hover:bg-[color-mix(in_oklab,var(--color-primary)_18%,var(--color-card))] ${i > 0 ? "border-t border-border-faint" : ""}`}
                >
            ...
            {cohort.map((r, i) => {
              ...
              return (
                <Link
                  key={r.id}
                  href={`/portfolio/${r.id}`}
                  className={`-mx-2 flex items-center gap-3 rounded-[6px] px-2 py-2.5 transition-colors duration-150 hover:bg-[color-mix(in_oklab,var(--color-primary)_18%,var(--color-card))] ${i > 0 ? "border-t border-border-faint" : ""}`}
                >
                  <span
                    aria-hidden="true"
