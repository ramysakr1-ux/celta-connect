        ...
        <div>
          ...
          {row.selfEvaluation ? (
            ...
            <form action={selfAction} className="mt-1 flex flex-col gap-1.5">
              ...
              <button type="submit" disabled={selfPending} className="self-start rounded-[6px] border border-border px-2.5 py-1 text-xs font-semibold text-ink hover:border-primary disabled:opacity-60">
        ...
        <div>
          ...
          {row.supervisorFeedback ? (
            ...
            <form action={fbAction} className="mt-1 flex flex-col gap-1.5">
              ...
              <button type="submit" disabled={fbPending} className="self-start rounded-[6px] border border-border px-2.5 py-1 text-xs font-semibold text-ink hover:border-primary disabled:opacity-60">
    ...
    <div className="rounded-[6px] border border-border p-3">
      ...
      <div className="mt-2">
        ...
        {row.privateDraft ? (
          ...
          <form action={draftAction} className="mt-1 flex flex-col gap-1.5">
            ...
            <button type="submit" disabled={draftPending} className="self-start rounded-[6px] border border-border px-2.5 py-1 text-xs font-semibold text-ink hover:border-primary disabled:opacity-60">
      ...
      {row.privateDraft && !row.finalizedAt ? (
        <form action={finalAction} className="mt-2 flex flex-col gap-1.5 border-t border-border-faint pt-2">
          ...
          <button type="submit" disabled={finalPending} className="self-start rounded-[6px] border border-border px-2.5 py-1 text-xs font-semibold text-ink hover:border-primary disabled:opacity-60">
      ...
      <div className="mt-2 border-t border-border-faint pt-2">
        ...
        {row.feedbackOnFeedbackNotes ? (
          ...
          <form action={fofAction} className="mt-1 flex flex-col gap-1.5">
            ...
            <button type="submit" disabled={fofPending} className="self-start rounded-[6px] border border-border px-2.5 py-1 text-xs font-semibold text-ink hover:border-primary disabled:opacity-60">
      ...
      <form className="flex flex-col gap-2">
        ...
        <div className="flex flex-wrap items-center gap-3">
          <button
            ...
            className="rounded-[6px] border border-border px-3 py-1.5 text-xs font-semibold text-ink hover:border-primary disabled:opacity-60"
          >
