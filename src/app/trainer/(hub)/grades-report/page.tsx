...
import { CloseOutCard } from "@/app/trainer/(hub)/grades-report/close-out-card";
import { CertificateCheckCard, type CertificateCandidate } from "@/app/trainer/(hub)/grades-report/certificate-check-card";
