...
export default async function SessionMaterialsPage({ searchParams }: { searchParams: Promise<{ event?: string }> }) {
  ...
  // Every non-TP event -- TP has its own tp_materials system already;
  // this is for everything else a trainer might want to share against
  // (a demo lesson, GTKY, an input session, any milestone).
