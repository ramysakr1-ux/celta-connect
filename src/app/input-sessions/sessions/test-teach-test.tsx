  ...
  return (
    <SessionShell
      ...
      agenda={[
        ...
        { time: "2–5", spine: "var(--color-gold)", title: "What is TTT?" },
        { time: "5–10", spine: "var(--color-gold)", title: "Match the terms" },
        { time: "10–13", spine: "var(--color-gold)", title: "Predict the staging" },
        { time: "13–23", spine: "var(--color-gold)", title: "Read the text, check ideas" },
        { time: "23–33", spine: "var(--color-gold)", title: "Detail questions" },
