      ...
      <div className="grid grid-cols-1 items-start gap-5 lg:grid-cols-[1.15fr_1fr]">
        ...
        <div className="flex flex-col gap-4">
          <div className="card p-5">
            <h2 className="font-serif text-h3 font-semibold text-ink">Asked once, read everywhere</h2>
          ...
          <div className="card card-gold p-5">
            <h2 className="font-serif text-h3 font-semibold text-ink">What comes next</h2>
            <p className="mt-1.5 text-meta leading-relaxed text-muted">
