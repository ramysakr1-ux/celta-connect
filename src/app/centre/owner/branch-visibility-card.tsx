...
export function BranchVisibilityCard({
  ...
  return (
    <div className="owner-card flex flex-col gap-4 px-7 py-6">
      <div>
        <h2 className="owner-serif text-h3">Cross-branch visibility</h2>
        <p className="mt-1.5 max-w-[720px] text-meta leading-relaxed" style={{ color: "var(--owner-muted)" }}>
          ...
          return (
            ...
            >
              <div>
                ...
                <span className="text-meta font-semibold">{target.name}</span>
              </div>
