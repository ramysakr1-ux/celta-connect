  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      {history.length === 0 ? (
        ...
        <div className="flex flex-col gap-8">
          {history.map((a) => (
            <div key={a.profileId} className="ring flex flex-col gap-4 rounded-[8px] border border-border bg-card p-[22px_24px]">
              ...
              <div className="overflow-hidden rounded-[6px] border border-border">
                ...
                {a.courses.map((c, i) => (
                  <div
                    key={c.id}
                    className={`ring grid grid-cols-[96px_1fr_minmax(0,160px)_96px] items-center gap-2 px-3 py-2.5 text-[12.5px] text-ink ${i > 0 ? "border-t border-border-faint" : ""}`}
                  >
