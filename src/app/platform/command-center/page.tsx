    ...
    <div className="container flex flex-col gap-6 py-8">
      ...
      <div className="grid grid-cols-2 gap-4 sm:grid-cols-4">
        <div className="card p-4">
          ...
          <p className="mt-1.5 font-serif text-2xl text-ink">{centresList.length}</p>
        </div>
        <div className="card p-4">
          <p className="text-xs font-semibold uppercase tracking-wide text-muted">MRR</p>
          <p className="mt-1.5 font-serif text-2xl text-ink">
        ...
        <div className="card p-4">
          ...
          <p className="mt-1.5 font-serif text-2xl text-ink">{renewalsDue.length}</p>
        </div>
        <div className="card p-4">
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
        <div className="card p-4">
          ...
          <p className="mt-1.5 font-serif text-xl text-ink">{centresList.length} centres</p>
        ...
        <div className="card p-4 opacity-60">
          ...
          <p className="mt-1.5 font-serif text-xl text-ink">Illustrative</p>
