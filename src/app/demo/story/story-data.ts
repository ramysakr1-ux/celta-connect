...
export const phases: StoryPhase[] = [
  ...
  { title: 'After the course', sub: 'The centre keeps everything; the course keeps nothing', days: [
    ...
    D('Then', 'Export', { centre: [N('PDFs to the centre\u2019s Drive', 'Plan + self-eval + feedback per TP · assignment rounds · CELTA 5 · letters', 'close', 'centre\u2019s own template document', '/centre/settings', 'c8', 'c9'), N('Assessor history', 'Handbook 13.3 / 13.8 · visible, not enforced', 'close', null, '/centre/assessor-history')], assessor: [N('Pack closes', 'Two weeks after the course ends -- the report window (Handbook 15)', 'close')] }, 25),
