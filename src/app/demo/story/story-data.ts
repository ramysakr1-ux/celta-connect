...
export const phases: StoryPhase[] = [
  ...
  { title: 'Week 1', sub: 'Days 1–5 · first lessons, first feedback, first assignments', days: [
    ...
    D('Day 2 · Tue', 'TP1 · ABC', { candidate: [TPd(1, 'A · B · C', 'B1', 't1', 't1s'), TPobs(1, 'DEF observes'), N('Self-evaluation', 'Due 22:00 · before the tutor writes', 'tp', null, '/portfolio/{me}/tp/1', 't1s', 't1f')], tutors: [FB(1, 't1f', 't2'), N('Releases A1', 'Focus on the Learner · evening before the Q&A', 'asg', 'candidate sees the brief and criteria', '/trainer/assignments', 'g1', 'g2')], volunteer: [VOL('B1')] }, 2),
  ...
  { title: 'Week 2', sub: 'Days 6–10 · Stage 2 reports, tutorials, the level changes', days: [
    ...
    D('Day 7 · Tue', 'TP3 · DEF', { candidate: [TPd(3, 'D · E · F', 'B1'), N('Filmed observation 2', 'With task', null, null, '/portfolio/{me}/filmed-observation/{filmed:2}')], tutors: [FB(3), N('A1 outcome', 'To standard · not to standard · one resubmission', 'asg', 'CELTA 5 record', '/trainer/assignments', 'g5')], volunteer: [VOL('B1')] }, 7),
  ...
  { title: 'Week 3', sub: 'Days 11–15 · own topics, supervised review, Stage 3 by invitation', days: [
    ...
    D('Day 12 · Tue', 'TP5 · DEF', { candidate: [TPd(5, 'D · E · F', 'A2')], tutors: [FB(5), N('Releases A3', 'Language skills related tasks', 'asg', null, '/trainer/assignments')], volunteer: [VOL('A2')] }, 12),
    ...
    D('Day 15 · Fri', 'Review day', { candidate: [N('Supervised review', 'Presenting language · phonology · classroom management · submit for tutor check', null, null, '/portfolio/{me}/timetable'), N('Stage 3 tutorial', 'By invitation only', 'close', null, '/portfolio/{me}/{tutorial:stage3}')], tutors: [N('Stage 3 tutorials', 'Those at risk · letter issued if needed', 'close', 'assessor pack shows the letter', '/trainer/timetable'), N('Unsupervised planning', 'The band runs without a tutor in the room -- still planning, still on the timetable')], centre: [N('Grade form prep', 'Centre grade form due 2–3 days before the visit', 'close', null, '/dashboard/admin/courses/{course}')] }, 15),
  ]},
  { title: 'Week 4', sub: 'Days 16–20 · final assessed lessons, deadlines, the visit, the close', days: [
    D('Day 16 · Mon', 'TP7 · ABC', { candidate: [TPd(7, 'A · B · C', 'A2 · own topic'), N('Filmed observations 4 & 5', 'With task', null, null, '/portfolio/{me}/filmed-observation/{filmed:4}')], tutors: [FB(7), N('Assessor meeting', 'Ahead of the visit · pack and sample agreed', 'close', 'assessor pack opens', '/trainer/assessor', 'c1', 'c2')], assessor: [N('Pack opens', 'Read-only · requirements, candidate readiness, double-marking sample', 'close', null, null, 'c2', 'c3')], volunteer: [VOL('A2')] }, 16),
