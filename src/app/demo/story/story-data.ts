...
export const phases: StoryPhase[] = [
  ...
  { title: 'Week 3', sub: 'Days 11–15 · own topics, supervised review, Stage 3 by invitation', days: [
    ...
    D('Day 15 · Fri', 'Review day', { candidate: [N('Supervised review', 'Presenting language · phonology · classroom management · submit for tutor check', null, null, '/portfolio/{me}/timetable'), N('Stage 3 tutorial', 'By invitation only', 'close', null, '/portfolio/{me}/timetable')], tutors: [N('Stage 3 tutorials', 'Those at risk · letter issued if needed', 'close', 'assessor pack shows the letter', '/trainer/timetable'), N('Early finish', '')], centre: [N('Grade form prep', 'Centre grade form due 2–3 days before the visit', 'close', null, '/dashboard/admin/courses/{course}')] }, 15),
  ]},
  ...
  { title: 'After the course', sub: 'The centre keeps everything; the course keeps nothing', days: [
    D('Days after', 'Confirmation', { centre: [N('Cambridge confirms grades', 'The MCT\u2019s close-out tick', 'close', null, '/dashboard/admin/courses/{course}', 'c7', 'c8')], tutors: [N('Issues letters', 'Reference letters · formal notices on record', 'close', null, '/trainer/roster')], candidate: [N('Sees the grade', 'Only now', 'close', null, null, 'c8b')] }, 23),
