...
export const phases: StoryPhase[] = [
  ...
  { title: 'Week 3', sub: 'Days 11–15 · own topics, supervised review, Stage 3 by invitation', days: [
    ...
    D('Day 15 · Fri', 'Review day', { candidate: [N('Supervised review', 'Presenting language · phonology · classroom management · submit for tutor check', null, null, '/portfolio/{me}/timetable'), N('Stage 3 tutorial', 'By invitation only', 'close', null, '/portfolio/{me}/timetable')], tutors: [N('Stage 3 tutorials', 'Those at risk · letter issued if needed', 'close', 'assessor pack shows the letter', '/trainer/timetable'), N('Early finish', '')], centre: [N('Grade form prep', 'Centre grade form due 2–3 days before the visit', 'close', null, '/dashboard/admin')] }, 15),
  ]},
  { title: 'Week 4', sub: 'Days 16–20 · final assessed lessons, deadlines, the visit, the close', days: [
    ...
    D('Day 20 · Fri', 'Course close', { tutors: [N('Course close', 'Whole cohort · nothing about grades is said', null, null, '/trainer/timetable'), N('Close-out checklist', 'Every record complete · export ready', 'close', null, '/trainer')], candidate: [N('Course finished', 'Workspace says so · no grade shown until Cambridge confirms', 'close')], centre: [N('Grade approval form', 'After the assessor\u2019s report · Appian', 'close', 'Cambridge confirms', '/dashboard/admin', 'c6', 'c7')], volunteer: [N('Certificate', 'If the hours threshold is reached', null, null, '/demo/journey/volunteer-certificate')] }, 20),
  ]},
  { title: 'After the course', sub: 'The centre keeps everything; the course keeps nothing', days: [
    D('Days after', 'Confirmation', { centre: [N('Cambridge confirms grades', 'The MCT\u2019s close-out tick', 'close', null, '/dashboard/admin', 'c7', 'c8')], tutors: [N('Issues letters', 'Reference letters · formal notices on record', 'close', null, '/trainer/roster')], candidate: [N('Sees the grade', 'Only now', 'close', null, null, 'c8b')] }, 23),
    D('Then', 'Export', { centre: [N('PDFs to the centre\u2019s Drive', 'Plan + self-eval + feedback per TP · assignment rounds · CELTA 5 · letters', 'close', 'centre\u2019s own template document', '/centre/settings', 'c8', 'c9'), N('Assessor history', 'Handbook 13.3 / 13.8 · visible, not enforced', 'close', null, '/centre/assessor-history')], assessor: [N('Pack closes', 'Read-only link expires', 'close')] }, 25),
