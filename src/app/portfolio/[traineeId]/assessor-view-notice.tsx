...
export function AssessorViewNotice() {
  return (
    <div className="mb-4 flex flex-wrap items-center gap-x-3 gap-y-2 rounded-[6px] border border-gold/40 bg-gold/10 px-4 py-2.5">
      <span className="text-label font-bold tracking-[0.08em] text-gold uppercase">Assessor view</span>
      ...
      <Link
        href="/assessor/exit"
        prefetch={false}
        className="ml-auto rounded-[6px] border border-border bg-card px-3 py-1 text-label font-medium text-ink wash"
      >
        Leave assessor view
      </Link>
    </div>
