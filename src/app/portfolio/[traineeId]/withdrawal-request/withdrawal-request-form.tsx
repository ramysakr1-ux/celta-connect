...
import { submitWithdrawalRequest, type WithdrawalRequestFormState } from "@/app/portfolio/[traineeId]/withdrawal-request-actions";
import {
  WITHDRAWAL_REASON_TAGS,
  WITHDRAW_CONFIRMATIONS,
  DEFER_CONFIRMATIONS,
} from "@/app/portfolio/[traineeId]/withdrawal-request-constants";
...
export function WithdrawalRequestForm({
  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      {!signatureName ? <SetSignatureForm fullName={fullName} /> : null}
    </div>
  );
}
