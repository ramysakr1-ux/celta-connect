...
1. Candidate can't teach twice in one day; tutor not expected to observe two groups in one day (Handbook 9.1.3).
2. Five of six assessed hours must be whole-class; the exception lesson can't be either of the final two (Handbook 9.1.2).
...
4. TP distributed evenly between the two tutors (Handbook 3.7).
5. Intensive TP block: 2-day minimum break, max 6 consecutive days (Handbook 9.1.3).
6. Mixed-mode Stage-3-borderline candidates: final two lessons locked to one mode (Handbook 10.2).
7. Assignment materials vs. TP lesson materials overlap check (Handbook 9.2).
8. End-of-course reports blocked before the final day (Handbook 14.4).

## ⬜ Unconfirmed — group 1b: administrative deadlines/eligibility (4 remaining)
1. Course-date submission deadline surfaced as a task (4 wks Moodle / 2 wks other) (Handbook 4.1).
2. Certificate-vs-recommended-grade check reappearing at close-out (Handbook 11.5).
3. Tutor can't be assigned to two concurrent full-time courses (Handbook 3.7).
4. Assessor history visible per centre (2 consecutive / 2 concurrent limits, not enforced by design, just visible) (Handbook 13.3).
